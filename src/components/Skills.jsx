...
function Skills() {
  return (
    <div name='skilss' className='w-full h-screen bg-[#292929]'>

        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full text-[#f5f5f5]'>
            <div>
                <p className='text-4xl font-bold inline  border-b-4 border-[#ED2939]'>Skills</p>
                <p className='py-4 text-[1.3rem]'>This are technologies i've worked with.</p>
            </div>
